(() => {
      ...
      <div class="admin-panel">
        ...
        <form id="addForm">
          <div class="form-grid">
            ...
            <div class="form-field"><label>Stock (copies available)</label><input name="stock" type="number" min="0" step="1" value="0" /></div>
  ...
  function renderBookList() {
    ...
    books.forEach((b) => {
      ...
      const stockInput = document.getElementById(`stock-${b.id}`);
      const saveStockBtn = document.getElementById(`savestock-${b.id}`);
      if (saveStockBtn) saveStockBtn.addEventListener('click', () => saveStock(b.id, stockInput.value));
  ...
  function bookRowHtml(b) {
    ...
    return `
      <div class="book-row">
        ...
        <input class="price-input" id="stock-${b.id}" type="number" min="0" step="1" value="${b.stock ?? 0}" title="Stock" />
        <button class="admin-submit" id="savestock-${b.id}" type="button" style="padding:6px 10px;">Save stock</button>
        ${isFree
